...
class FGMembersite1
{
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query =$query = "INSERT INTO $this->tablename (name, email, username, password, confirmcode) VALUES
        ('" . $_POST["name"] . "', '" . $_POST["email"] . "', '" . $_POST["username"] . "', '" . md5($_POST["password"]) . "', '" . $confirmcode . "')";
